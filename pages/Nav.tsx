...
export const Nav = () => {
  return (
    <div className="border-gray-200 relative  top-0  right-0 flex  min-w-0 justify-between bg-darkgray px-6 ">
      <div className="top-0 right-0 m-5 flex bg-darkgray">
        <nav className="flex flex-wrap items-center justify-between overflow-x-auto bg-darkgray p-2 text-blue ">
          <div className="inline-block w-auto flex-wrap lg:flex lg:w-auto lg:items-center">
            <div className="text-sm lg:flex-grow">
              ...
              <Link
                href="https://github.com/DynamicApproach/"
                target={"_blank"}
              >
                <p className="mt-4 mr-4 block cursor-pointer font-sans text-nextblue hover:text-white lg:mt-0">
                  GitHub
