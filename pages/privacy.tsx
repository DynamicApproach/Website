...
const Privacy = () => {
  return (
    ...
    from-backgray to-albanypurp bg-cover bg-scroll text-white"
    >
      <h1>Privacy Policy</h1>
      <p>
        We take your privacy seriously. This privacy policy describes what
      ...
      <p>
        Where necessary, we use cookies to store information about a
      ...
      <p>
        ...
        browser documentation for instructions on how to block cookies and other
        tracking mechanisms.
      </p>
