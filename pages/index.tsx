...
const Home: NextPage = () => (
  <div className="light:bg-white static mx-auto bg-darkgray ">
    <Nav />

    <Head>
      <title className="border-lime-300">Thomas Lloyd-Jones</title>
    ...
    <footer className={styles.footer}>Powered by {addonList}</footer>
  </div>
);
